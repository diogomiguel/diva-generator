...
export function IntroScreen({ onStart }: IntroScreenProps) {
  return (
    <div className="max-h-dvh overflow-hidden flex flex-col items-center justify-center px-4 py-0 relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">

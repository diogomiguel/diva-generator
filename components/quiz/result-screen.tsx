...
export function ResultScreen({ title, description, onRetake }: ResultScreenProps) {
  ...
  return (
    <div className="h-dvh overflow-hidden flex flex-col items-center justify-center px-4 py-8 relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
